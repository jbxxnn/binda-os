...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white via-[#E89BFF]/8 to-white" />

      <motion.div
        className="absolute top-20 left-10 w-24 h-24 rounded-full bg-[#E89BFF]/25 blur-3xl"
        animate={{
          x: [0, 30, 0],
          y: [0, -20, 0],
          scale: [1, 1.1, 1],
      ...
      />
      <motion.div
        className="absolute bottom-40 right-20 w-32 h-32 rounded-full bg-[#E89BFF]/15 blur-3xl"
        animate={{
          x: [0, -40, 0],
          y: [0, 30, 0],
          scale: [1, 1.2, 1],
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-12">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <motion.div style={{ opacity }} className="space-y-5">
            ...
            >
              <motion.span
                className="w-2 h-2 bg-[#E89BFF] rounded-full"
            ...
            <div className="space-y-1 overflow-hidden">
              ...
              >
                <motion.span
                  ...
                  animate="visible"
                  custom={2}
                  className="inline-block text-[#E89BFF]"
                >
                  AMBITION
                </motion.span>
              </motion.h1>
            ...
            >
              <motion.button
                className="bg-[#E89BFF] text-[#121212] px-6 py-3 rounded-full font-bold text-sm tracking-wide flex items-center gap-2 group relative overflow-hidden"
            ...
            >
              {["Zero Sugar", "75mg Caffeine", "Natural Flavours", "Vitamin B Rich"].map((benefit, i) => (
                ...
                >
                  <div className="w-1.5 h-1.5 bg-[#E89BFF] rounded-full" />
                  {benefit}
                </motion.div>
              ))}
            </motion.div>
          ...
          <motion.div style={{ y, scale }} className="relative flex justify-center">
            <motion.div variants={scaleInVariants} initial="hidden" animate="visible" className="relative">
              <motion.div
                className="absolute inset-0 bg-[#E89BFF]/30 blur-[80px] rounded-full scale-75"
                animate={{
