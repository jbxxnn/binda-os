      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          {activations.map((activation) => (
            ...
            >
              <motion.div
                className="absolute inset-0 bg-[#E89BFF]/0 group-hover:bg-[#E89BFF]"
                transition={{ duration: 0.4 }}
              />

              <div className="relative z-10">
                <motion.div
                  className="w-11 h-11 rounded-xl bg-[#E89BFF] flex items-center justify-center mb-4 group-hover:bg-[#121212] transition-colors duration-300"
                  whileHover={{ rotate: 10, scale: 1.1 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                >
                  <activation.icon className="w-5 h-5 text-[#121212] group-hover:text-[#E89BFF] transition-colors duration-300" />
                </motion.div>
                ...
                <motion.button
                  className="flex items-center gap-2 text-[#E89BFF] group-hover:text-[#121212] font-bold text-xs tracking-wide transition-colors duration-300"
                  whileHover={{ x: 4 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                >
                  {activation.cta}
